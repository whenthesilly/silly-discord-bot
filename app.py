...
@bot.slash_command(guild_ids=["1065613788470071337"], description = 'Applies the latest changes globally.')
...
@bot.slash_command(description = "Makes the silly garflid image speak (image by @willy on wasteof)")
